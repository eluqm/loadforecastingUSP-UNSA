...
%ESN03054500TygartMonthD_leaky_ramdom_ridge
        ...
        net_ESN=load_esn(strcat(Basin_name,'_leaky_nonSTD_RIDGE_rand5_80'));
...
%                   %Rvt= tomasandfiering(val,m)
  ...
  %%     5:ANFIS
      ...
      %% SAVE NRMSE for plot
      csvwrite(strcat(Basin_name,'_T_Fiering_random_sum_80_last_',num2str(years)),Best_to_plot1);
      csvwrite(strcat(Basin_name,'_T_Fiering_model_sum_80_last_',num2str(years)),Best_to_plot2);
      csvwrite(strcat(Basin_name,'_ESN_sum_80_last_',num2str(years)),Best_to_plot3);
      csvwrite(strcat(Basin_name,'_PEN_sum_80_last_',num2str(years)),Best_to_plot4);
      csvwrite(strcat(Basin_name,'_ANFIS_sum_80_last_',num2str(years)),Best_to_plot5);
      ...
      csvwrite(strcat(Basin_name,'_final_result_sum_80_last_',num2str(years)),final_results);
