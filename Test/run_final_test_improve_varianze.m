...
%ESN03054500TygartMonthD_leaky_ramdom_ridge
        ...
        net_ESN=load_esn('ESN03054500_leaky_STD_RIDGE_rand5_80_nonScaling_1');
...
%                   %Rvt= tomasandfiering(val,m)
  ...
  %%     5:ANFIS
      ...
      %% SAVE NRMSE for plot
      csvwrite(strcat(prefix,'_T_Fiering_randomSTD_prod_80_improve_nsc75_',num2str(var_factor),'_',num2str(years)),Best_to_plot1);
      csvwrite(strcat(prefix,'_T_Fiering_modelSTD_prod_80_improve_nsc75_',num2str(var_factor),'_',num2str(years)),Best_to_plot2);
      csvwrite(strcat(prefix,'_ESNSTD_prod_80_improve_ncs75_',num2str(var_factor),'_',num2str(years)),Best_to_plot3);
      csvwrite(strcat(prefix,'_PENSTD_prod_80_improve_ncs75_',num2str(var_factor),'_',num2str(years)),Best_to_plot4);
      csvwrite(strcat(prefix,'_ANFISSTD_prod_80_improve_ncs75_',num2str(var_factor),'_',num2str(years)),Best_to_plot5);
      ...
      csvwrite(strcat(prefix,'_final_resultSTD_prod_80_improve_ncs75_',num2str(var_factor),'_',num2str(years)),final_results);
