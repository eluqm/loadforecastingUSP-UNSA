...
public class ReadMain {
	...
	public static void main(String[] args) throws IOException
	{
		...
		int caract=0;
		BufferedWriter out= new BufferedWriter(new FileWriter("../source/01518000TIOGAMonth.dly.txt"));
		BufferedReader buf = new BufferedReader(new FileReader("../source/01518000TIOGA.dly.txt"));
		String line= null;
		String[] wordsLine;
		String[] newwordsline;
